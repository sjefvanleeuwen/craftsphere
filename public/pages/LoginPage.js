...
export class LoginPage extends LitElement {
    static properties = {
        showLogin: { type: Boolean, reflect: true },
        emailError: { type: String, state: true },
        usernameError: { type: String, state: true },
        passwordError: { type: String, state: true },
        confirmPasswordError: { type: String, state: true },
        registrationError: { type: String, state: true }
    };
    ...
    render() {
        return html`
            <div class="login-container">
                <div id="loginForm" style="display: ${this.showLogin ? 'block' : 'none'}">
                    <h2>Sign In</h2>
                ...
                <div id="registerForm" style="display: ${this.showLogin ? 'none' : 'block'}">
                    <h2>Register</h2>
